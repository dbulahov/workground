...
public class TestFormatStringExpressionCubeNoCacheModifier implements CatalogMappingSupplier {
    ...
    public TestFormatStringExpressionCubeNoCacheModifier(CatalogMapping baseCatalog) {
        ...
        VIRTUAL_CUBE_WAREHOUSE_AND_SALES_FORMAT_EXPRESSION.getReferencedMeasures().addAll((Collection<? extends BaseMeasure>) List.of(
                copier.get(CatalogSupplier.MEASURE_STORE_COST), copier.get(CatalogSupplier.MEASURE_STORE_SALES), MEASURE_UNITS_SHIPPED_LOCAL));

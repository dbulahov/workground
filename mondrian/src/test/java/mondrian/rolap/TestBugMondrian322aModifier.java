...
public class TestBugMondrian322aModifier implements CatalogMappingSupplier {
    ...
    public TestBugMondrian322aModifier(CatalogMapping baseCatalog) {
...
*/
        ...
        VIRTUAL_CUBE_WAREHOUSE_AND_SALES2.getDimensionConnectors()
                .addAll((Collection<? extends DimensionConnector>) List.of(copier.get(CatalogSupplier.CONNECTOR_CUSTOMER), copier.get(CatalogSupplier.CONNECTOR_TIME), copier.get(CatalogSupplier.CONNECTOR_WAREHOUSE_WAREHOUSE)));

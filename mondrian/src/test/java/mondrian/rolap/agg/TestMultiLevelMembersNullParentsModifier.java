 ...
 * Creates a cube "Warehouse2" with custom Warehouse dimension having address3, address2, address1, and name levels.
 *
 ...
 * </Cube>
 */
public class TestMultiLevelMembersNullParentsModifier implements CatalogMappingSupplier {
    ...
    public TestMultiLevelMembersNullParentsModifier(CatalogMapping baseCatalog) {

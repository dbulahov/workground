...
public class ExplicitRecognizerTestModifierEmf implements CatalogMappingSupplier {
    ...
    public ExplicitRecognizerTestModifierEmf(CatalogMapping catalogMapping) {
    ...
    protected void createMeasures() {
        ...
        unitSales.setColumn(CatalogSupplier.COLUMN_UNIT_SALES_SALESFACT);
        ...
        avgUnitSales.setColumn(CatalogSupplier.COLUMN_UNIT_SALES_SALESFACT);
    ...
    protected DimensionConnector createTimeExtraDimension() {
        ...
        timeQuery.setTable(CatalogSupplier.TABLE_TIME_BY_DAY);

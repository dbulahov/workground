...
public class TestSsasCompatNamingInAggModifier implements CatalogMappingSupplier {
    ...
    public TestSsasCompatNamingInAggModifier(CatalogMapping baseCatalog) {
        ...
        lineTenantJoinRight.setKey(tenantIdLineTenant);
        ...
        lineTenantToTenant.setLeft(lineTenantJoinRight);

...
public class AggMeasureFactCountTestModifierEmf implements CatalogMappingSupplier {
    ...
    public static PhysicalColumn timeIdColumnInTimeCsv;
    public static PhysicalColumn theYearColumnInTimeCsv;
    public static PhysicalColumn monthOfYearColumnInTimeCsv;
    public static PhysicalColumn quarterColumnInTimeCsv;
    public static PhysicalColumn dayOfMonthColumnTimeCsv;
    public static PhysicalColumn weekOfYearColumnInTimeCsv;
    public static PhysicalTable timeCsvTable;

    // Fact CSV 2016 table columns
    public static PhysicalColumn productIdColumnInFactCsv2016;
    public static PhysicalColumn timeIdColumnInFactCsv2016;
    public static PhysicalColumn customerIdColumnInFactCsv2016;
    public static PhysicalColumn promotionIdColumnInFactCsv2016;
    public static PhysicalColumn storeIdColumnInFactCsv2016;
    public static PhysicalColumn storeSalesColumnInFactCsv2016;
    public static PhysicalColumn storeCostColumnInFactCsv2016;
    public static PhysicalColumn unitSalesColumnInFactCsv2016;
    public static PhysicalTable factCsv2016Table;

    // Aggregation table: agg_c_6_fact_csv_2016
    public static PhysicalColumn monthOfYearAggC6FactCsv2016;
    public static PhysicalColumn quarterAggC6FactCsv2016;
    public static PhysicalColumn theYearAggC6FactCsv2016;
    public static PhysicalColumn storeSalesAggC6FactCsv2016;
    public static PhysicalColumn storeCostAggC6FactCsv2016;
    public static PhysicalColumn unitSalesAggC6FactCsv2016;
    public PhysicalColumn customerCountAggC6FactCsv2016;
    public static PhysicalColumn factCountAggC6FactCsv2016;
    public static PhysicalColumn storeSalesFactCountAggC6FactCsv2016;
    public static PhysicalColumn storeCostFactCountAggC6FactCsv2016;
    public static PhysicalColumn unitSalesFactCountAggC6FactCsv2016;
    public static PhysicalTable aggC6FactCsv2016;

    // Aggregation table: agg_csv_different_column_names
    public static PhysicalColumn monthOfYearAggCsvDifferentColumnNames;
    public static PhysicalColumn quarterAggCsvDifferentColumnNames;
    public static PhysicalColumn theYearAggCsvDifferentColumnNames;
    public static PhysicalColumn storeSalesAggCsvDifferentColumnNames;
    public static PhysicalColumn storeCostAggCsvDifferentColumnNames;
    public static PhysicalColumn unitSalesAggCsvDifferentColumnNames;
    public static PhysicalColumn customerCountAggCsvDifferentColumnNames;
    public static PhysicalColumn factCountAggCsvDifferentColumnNames;
    public static PhysicalColumn ssFcAggCsvDifferentColumnNames;
    public static PhysicalColumn scFcAggCsvDifferentColumnNames;
    public static PhysicalColumn usFcAggCsvDifferentColumnNames;
    public static PhysicalTable aggCsvDifferentColumnNames;

    // Aggregation table: agg_csv_divide_by_zero
    public static PhysicalColumn monthOfYearAggCsvDivideByZero;
    public static PhysicalColumn quarterAggCsvDivideByZero;
    public static PhysicalColumn theYearAggCsvDivideByZero;
    public static PhysicalColumn storeSalesAggCsvDivideByZero;
    public static PhysicalColumn storeCostAggCsvDivideByZero;
    public static PhysicalColumn unitSalesAggCsvDivideByZero;
    public static PhysicalColumn customerCountAggCsvDivideByZero;
    public static PhysicalColumn factCountAggCsvDivideByZero;
    public static PhysicalColumn storeSalesFactCountAggCsvDivideByZero;
    public static PhysicalColumn storeCostFactCountAggCsvDivideByZero;
    public static PhysicalColumn unitSalesFactCountAggCsvDivideByZero;
    public static PhysicalTable aggCsvDivideByZero;
    ...
    public AggMeasureFactCountTestModifierEmf(CatalogMapping catalogMapping) {

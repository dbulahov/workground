...
public class TestCalculatedDefaultMeasureOnVirtualCubeNoThrowExceptionModifier implements CatalogMappingSupplier {
    ...
    public TestCalculatedDefaultMeasureOnVirtualCubeNoThrowExceptionModifier(CatalogMapping baseCatalog) {
        ...
        VIRTUAL_CUBE.getDimensionConnectors().add(VIRTUAL_CONNECTOR_STORE);
